    ...
    public partial class Kholodilov_2 : Form
    {
        ...
        public void view_datagreed()
        {
            if (Int32.Parse(num_point.Text) > 0)
            {
                ...
                {
                    dataGridView1.RowCount += 1;
                    dataGridView1.Rows[i].Cells[0].Value = generated_point[i, 0];
                    dataGridView1.Rows[i].Cells[1].Value = generated_point[i, 1];
                    dataGridView1.Rows[i].Cells[2].Value = generated_point[i, 2];
                }
            }
        }
        ...
        private void generate_var_Click(object sender, EventArgs e)
        {
            if (Int32.Parse(num_point.Text) > 0)
            {
